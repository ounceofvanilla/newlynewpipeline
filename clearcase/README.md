ClearCase Sample Repository
This repository contains a sample implementation of DOCPF using source code that exists in ClearCase.

Getting Started
These instructions will explain how to stand up the sample ClearCase pipeline on a Jenkins instance.
